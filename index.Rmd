...
centro_america = world[world$name_long == "Belize" |
                       ...
                       world$name_long == "Panama"
                       , ]
lifeExp.ordenado <- order(centro_america$lifeExp, decreasing=TRUE)
centro_america.lifeExp <- centro_america[lifeExp.ordenado,]

barplot(
  height=centro_america.lifeExp$lifeExp, 
  names.arg=centro_america.lifeExp$iso_a2, 
  xlab="País", 
  ylab="Esperanza de vida", 
  main="Esperanza de vida en Centro America"
) 
```
...
```{r}
plot(centro_america["lifeExp"], main="Esperanza de vida en Centro America")
